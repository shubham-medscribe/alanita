function generateFlightURL(
  ...
  let params = `siid=99316&AirSegCount=${segments.length}&aCount=${
    options?.adults || 1
  }`;
  ...
  segments.forEach((segment, index) => {
    const segmentParams = `${segment.departure}|${segment.destination}|${segment.departDate}`;
    const arr1 = [
      "|",
      "",
      "|",
  ...
  [
    {
      departure: "BOM",
      destination: "DEL",
      departDate: "03/18/2025",
      time: "mo",
    },
    {
      departure: "DEL",
      destination: "NYC",
      departDate: "03/20/2025",
      time: "ev",
    },
  ],
  {
