  ...
  return (
    <div className="w-full flex flex-col items-center text-gray-900">
      <div className="w-full max-w-[1347px]">
        <div className="p-4">
          <div>
            <h2 className="mb-4 text-2xl font-semibold">CC Date Change Form</h2>
          </div>
          ...
          <div className="mt-8 w-full">
            <iframe
              ...
              width="100%"
              scrolling="yes"
              src="https://secure.rightsignature.com/templates/d4fdb4c1-17ea-4c90-977c-516209eef8bd/template-signer-link/c8a2306bfe6f440df178cedf389b5cda"
